...
const TRAITS = [
  ...
  {id:'t71', cats:['신체'], name:'발가락 길이 비율', nameEn:'Toe Length Ratio', gene:'다인자 유전', lm:'LOWER_L', lm2:'LOWER_R', assoc:3.5, vis:'외적', bodyPos:{x:0.440, y:0.970}, plei:[]},
  ...
  {id:'t62', cats:['운동'], name:'지구력형 하체 체질', nameEn:'Endurance Lower Body Type', gene:'ACE I/D variant', lm:'LOWER_L', lm2:'CHEST_C', assoc:4, vis:'내적', bodyPos:{x:0.380, y:0.800}, plei:['t61']},
  ...
  {id:'t74', cats:['신체'], name:'하지 부종', nameEn:'Lower Limb Edema', gene:'순환·림프 관련 복합', lm:'LOWER_R', lm2:'LOWER_L', assoc:3.5, vis:'조건부', bodyPos:{x:0.640, y:0.880}, plei:['t73']},
  ...
  {id:'t67', cats:['신체'], name:'발 크기/발 모양', nameEn:'Foot Size / Foot Shape', gene:'다인자 유전', lm:'LOWER_L', lm2:'LOWER_R', assoc:3.5, vis:'외적', bodyPos:{x:0.400, y:0.950}, plei:[]},
  ...
  {id:'t68', cats:['신체'], name:'발목 유연성', nameEn:'Ankle Flexibility', gene:'다인자 유전', lm:'LOWER_R', lm2:'LOWER_L', assoc:3.5, vis:'외적', bodyPos:{x:0.600, y:0.950}, plei:[]},
  ...
  {id:'t59', cats:['신체'], name:'다리 길이 비대칭', nameEn:'Leg Length Asymmetry', gene:'유전성 편측비대 관련', lm:'LOWER_L', lm2:'LOWER_R', assoc:5, vis:'외적', bodyPos:{x:0.380, y:0.750}, plei:[]},
  ...
  {id:'t60', cats:['신체'], name:'근감소 경향', nameEn:'Muscle Loss (Sarcopenia) Tendency', gene:'ADAM8 BECN1 KLF4', lm:'LOWER_C', lm2:'ARM_L', assoc:4.5, vis:'조건부', bodyPos:{x:0.500, y:0.720}, plei:['t61']},
  {id:'t70', cats:['신체'], name:'발바닥 압력/보행 패턴', nameEn:'Plantar Pressure / Gait Pattern', gene:'복합유전', lm:'LOWER_C', lm2:'LOWER_L', assoc:3, vis:'조건부', bodyPos:{x:0.380, y:0.852}, plei:[]}
];
