...
const TRAITS = [
  ...
  {id:'t21', cats:['감각','신체'], name:'암내', nameEn:'Body Odor', gene:'ABCC11 rs1782293', lm:'ARM_L', lm2:'CHEEK_C', assoc:5, vis:'조건부', bodyPos:{x:0.376, y:0.268}, plei:['t5']},
  {id:'t31', cats:['운동'], name:'근육발달', nameEn:'Muscle Development', gene:'ACTN3 rs1815739', lm:'ARM_R', lm2:'LOWER_L', assoc:4.5, vis:'조건부', bodyPos:{x:0.300, y:0.417}, plei:[]},
  ...
  {id:'t51', cats:['사회','인지'], name:'타인 신뢰 경향', nameEn:'Tendency to Trust Others', gene:'CD38 rs1044482', lm:'FOREHEAD', lm2:'CHEST_CL', assoc:3.5, vis:'내적', bodyPos:{x:0.608, y:0.268}, plei:['t6']},
  ...
  {id:'t71', cats:['신체'], name:'발가락 길이 비율', nameEn:'Toe Length Ratio', gene:'다인자 유전', lm:'LOWER_L', lm2:'LOWER_R', assoc:3.5, vis:'외적', bodyPos:{x:0.446, y:0.912}, plei:[]},
  ...
  {id:'t12', cats:['신체'], name:'모발 생성', nameEn:'Hair Formation', gene:'EDAR rs3827760', lm:'TOP', lm2:'CHEEK_R', assoc:4, vis:'외적', bodyPos:{x:0.515, y:0.136}, plei:['t16']},
  ...
  {id:'t42', cats:['인지','사회'], name:'사회적 거부 민감도', nameEn:'Social Rejection Sensitivity', gene:'OPRM1 rs1799971', lm:'BRAIN_C', lm2:'CHEST_C', assoc:2, vis:'조건부', bodyPos:{x:0.490, y:0.210}, plei:[]},
  ...
  {id:'t62', cats:['운동'], name:'지구력형 하체 체질', nameEn:'Endurance Lower Body Type', gene:'ACE I/D variant', lm:'LOWER_L', lm2:'CHEST_C', assoc:4, vis:'내적', bodyPos:{x:0.442, y:0.799}, plei:['t61']},
  {id:'t72', cats:['신체'], name:'다리 털/체모 농도', nameEn:'Leg Hair / Body Hair Density', gene:'다인자 유전', lm:'LOWER_R', lm2:'LOWER_L', assoc:3, vis:'외적', bodyPos:{x:0.592, y:0.861}, plei:[]},
  ...
  {id:'t23', cats:['인지','행동'], name:'불안감/기분조절', nameEn:'Anxiety / Mood Regulation', gene:'BDNF SLC6A4', lm:'BRAIN_L', lm2:'FOREHEAD', assoc:3.5, vis:'내적', bodyPos:{x:0.509, y:0.178}, plei:['t17','t54']},
  {id:'t33', cats:['인지'], name:'행복기본값', nameEn:'Baseline Happiness', gene:'FAAH rs324420', lm:'BRAIN_CR2', lm2:'FOREHEAD', assoc:3, vis:'내적', bodyPos:{x:0.486, y:0.131}, plei:[]},
  {id:'t43', cats:['행동'], name:'수면시간 성향', nameEn:'Sleep Duration Tendency', gene:'DEC2 rs121912617', lm:'BRAIN_B', lm2:'CHEST_R', assoc:4, vis:'내적', bodyPos:{x:0.482, y:0.243}, plei:[]},
  {id:'t53', cats:['행동','사회'], name:'공격성 방향', nameEn:'Direction of Aggression', gene:'HTR2A rs6311', lm:'BRAIN_R', lm2:'FOREHEAD', assoc:3.5, vis:'내적', bodyPos:{x:0.491, y:0.101}, plei:[]},
  ...
  {id:'t24', cats:['신체'], name:'탈모 성향', nameEn:'Hair Loss Tendency', gene:'AR rs1385699', lm:'TOP_R', lm2:'BODY_C', assoc:4.5, vis:'외적', bodyPos:{x:0.474, y:0.134}, plei:[]},
  ...
  {id:'t44', cats:['신체'], name:'피부 탄력/노화', nameEn:'Skin Elasticity / Aging', gene:'MMP1 rs1799750', lm:'CHEEK_R', lm2:'CHEEK_L', assoc:4, vis:'외적', bodyPos:{x:0.458, y:0.269}, plei:[]},
  {id:'t54', cats:['인지','행동'], name:'손실 회피 성향', nameEn:'Loss Aversion Tendency', gene:'SLC6A4 rs25531', lm:'FOREHEAD_L', lm2:'BRAIN_L', assoc:4, vis:'내적', bodyPos:{x:0.460, y:0.137}, plei:['t23']},
  {id:'t64', cats:['신체'], name:'엉덩이/골반 체형', nameEn:'Hip / Pelvis Body Shape', gene:'다인자 유전', lm:'LOWER_C', lm2:'STOMACH_B', assoc:4, vis:'외적', bodyPos:{x:0.441, y:0.602}, plei:['t67','t68']},
  {id:'t74', cats:['신체'], name:'하지 부종', nameEn:'Lower Limb Edema', gene:'순환·림프 관련 복합', lm:'LOWER_R', lm2:'LOWER_L', assoc:3.5, vis:'조건부', bodyPos:{x:0.618, y:0.843}, plei:['t73']},
  ...
  {id:'t15', cats:['행동'], name:'아침형/저녁형', nameEn:'Morning / Evening Person', gene:'PER3 rs1801260', lm:'BRAIN_C', lm2:'BRAIN_B', assoc:4, vis:'내적', bodyPos:{x:0.505, y:0.172}, plei:[]},
  ...
  {id:'t35', cats:['인지','행동'], name:'우울증 민감도', nameEn:'Depression Sensitivity', gene:'LHPP SIRT1', lm:'FOREHEAD', lm2:'CHEST_R', assoc:2.5, vis:'내적', bodyPos:{x:0.544, y:0.123}, plei:[]},
  ...
  {id:'t6',  cats:['인지','사회'], name:'공감능력', nameEn:'Empathy', gene:'OXTR rs53576', lm:'FOREHEAD', lm2:'CHEST_C', assoc:3.5, vis:'내적', bodyPos:{x:0.510, y:0.159}, plei:['t19','t51']},
  {id:'t16', cats:['신체'], name:'머리카락 굵기', nameEn:'Hair Thickness', gene:'EDAR rs3827760', lm:'TOP', lm2:'CHEEK_L', assoc:4, vis:'외적', bodyPos:{x:0.498, y:0.139}, plei:['t12']},
  ...
  {id:'t7',  cats:['행동','인지'], name:'강박성 성향', nameEn:'Obsessive-Compulsive Tendency', gene:'전전두엽-기저핵', lm:'FOREHEAD', lm2:'BRAIN_C', assoc:3, vis:'내적', bodyPos:{x:0.486, y:0.125}, plei:[]},
  {id:'t17', cats:['인지'], name:'단기 기억력', nameEn:'Short-Term Memory', gene:'BDNF rs6265', lm:'TEMPLE_R', lm2:'FOREHEAD', assoc:4, vis:'내적', bodyPos:{x:0.508, y:0.115}, plei:['t23']},
  ...
  {id:'t67', cats:['신체'], name:'발 크기/발 모양', nameEn:'Foot Size / Foot Shape', gene:'다인자 유전', lm:'LOWER_L', lm2:'LOWER_R', assoc:3.5, vis:'외적', bodyPos:{x:0.419, y:0.924}, plei:[]},
  ...
  {id:'t8',  cats:['인지'], name:'희망/기대 성향', nameEn:'Hope / Expectation Tendency', gene:'해마/변연계', lm:'BRAIN_T', lm2:'BRAIN_CL', assoc:3, vis:'내적', bodyPos:{x:0.497, y:0.192}, plei:[]},
  {id:'t18', cats:['감각','인지'], name:'통증 민감도', nameEn:'Pain Sensitivity', gene:'COMT rs4680', lm:'BODY_C', lm2:'BRAIN_L', assoc:4, vis:'조건부', bodyPos:{x:0.568, y:0.129}, plei:[]},
  {id:'t28', cats:['대사','감각'], name:'초콜릿 선호', nameEn:'Chocolate Preference', gene:'보상회로', lm:'MOUTH', lm2:'LIVER', assoc:3.5, vis:'조건부', bodyPos:{x:0.482, y:0.228}, plei:[]},
  {id:'t38', cats:['행동','인지'], name:'불확실성 선호', nameEn:'Uncertainty Preference', gene:'DRD4 7R variant', lm:'FOREHEAD_L', lm2:'BRAIN_B', assoc:3, vis:'내적', bodyPos:{x:0.591, y:0.238}, plei:['t41','t45']},
  ...
  {id:'t68', cats:['신체'], name:'발목 유연성', nameEn:'Ankle Flexibility', gene:'다인자 유전', lm:'LOWER_R', lm2:'LOWER_L', assoc:3.5, vis:'외적', bodyPos:{x:0.620, y:0.917}, plei:[]},

  {id:'t9',  cats:['사회','인지'], name:'사회성', nameEn:'Sociability', gene:'사회인지 네트워크', lm:'BRAIN_CR', lm2:'TEMPLE_L', assoc:3.5, vis:'내적', bodyPos:{x:0.565, y:0.154}, plei:[]},
  {id:'t19', cats:['인지','행동'], name:'스트레스 회복력', nameEn:'Stress Resilience', gene:'OXTR rs2254298', lm:'BRAIN_C', lm2:'CHEST_C', assoc:3, vis:'내적', bodyPos:{x:0.533, y:0.279}, plei:['t6','t51']},
  ...
  {id:'t59', cats:['신체'], name:'다리 길이 비대칭', nameEn:'Leg Length Asymmetry', gene:'유전성 편측비대 관련', lm:'LOWER_L', lm2:'LOWER_R', assoc:5, vis:'외적', bodyPos:{x:0.419, y:0.736}, plei:[]},
  ...
  {id:'t20', cats:['운동','행동'], name:'단기 폭발 에너지', nameEn:'Short-Term Explosive Energy', gene:'ACTN3 rs1815739', lm:'CHEST_R', lm2:'ARM_R', assoc:4.5, vis:'조건부', bodyPos:{x:0.340, y:0.342}, plei:['t52','t55']},
  {id:'t30', cats:['인지','행동'], name:'습관 형성', nameEn:'Habit Formation', gene:'선조체', lm:'FOREHEAD', lm2:'BRAIN_C', assoc:4, vis:'내적', bodyPos:{x:0.510, y:0.107}, plei:[]},
  {id:'t40', cats:['인지'], name:'지능(IQ)', nameEn:'Intelligence (IQ)', gene:'SHANK3 NR2B', lm:'TOP', lm2:'BRAIN_C', assoc:3.5, vis:'내적', bodyPos:{x:0.505, y:0.138}, plei:[]},
  ...
  {id:'t60', cats:['신체'], name:'근감소 경향', nameEn:'Muscle Loss (Sarcopenia) Tendency', gene:'ADAM8 BECN1 KLF4', lm:'LOWER_C', lm2:'ARM_L', assoc:4.5, vis:'조건부', bodyPos:{x:0.622, y:0.718}, plei:['t61']},
  {id:'t70', cats:['신체'], name:'발바닥 압력/보행 패턴', nameEn:'Plantar Pressure / Gait Pattern', gene:'복합유전', lm:'LOWER_C', lm2:'LOWER_L', assoc:3, vis:'조건부', bodyPos:{x:0.431, y:0.816}, plei:[]}
];
